...
- **LTX-2.5** — Distilled (`ltx25_distilled`, ~100GB), Dev two-stage (`ltx25_dev`, same pack), and Distilled Q8 DiT (`ltx25_distilled_ditq8`). Gemma 4 is bundled. The app installs `dgrauet/ltx-2-mlx` 0.15+ only when you pick a 2.5 model.
...
- **Local REST API** - `127.0.0.1:8420` (`ltx25_distilled`, `ltx25_dev`, `ltx25_distilled_ditq8`, `minimax_h3`, `minimax_h3_int8`, `minimax_h3_turbo`)
