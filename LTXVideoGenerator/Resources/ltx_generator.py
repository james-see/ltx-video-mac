...
class LTXGenerator:
    ...
    def load_model(self) -> None:
        ...
        print(f"Loading LTX-2 model ({self.model_variant}) on Apple Silicon...", file=sys.stderr)
        ...
        print(f"Model loaded with {self.dtype}!", file=sys.stderr)
    ...
    def generate(
        ...
        print(f"  Steps: {num_inference_steps}, Guidance: {guidance_scale}", file=sys.stderr)
...
"""
    ...
    parser.add_argument("--guidance", type=float, default=None, help="Guidance scale (default: varies by model)")
