...
enum LTXModelCatalog {
    ...
    static let all: [LTXModel] = [
        ...
        LTXModel(
            ...
            supportsBuiltInAudio: true,
            qualityWarning: "Official production path: half-res dev+CFG, upscale, fuse distilled LoRA into the dev DiT. First Dev generate downloads ltx-2.5-22b-distilled-lora-450-bf16 (~8.3GB). Much slower. 64GB+; 128GB comfortable.",
            recommendedStepsLower: 20,
            recommendedStepsUpper: 40,
            tips: "Uses transformer-dev.safetensors + official distilled LoRA for Stage 2. Slider is stage-1 steps (default 30). Stage-2 is 3. CFG default 3. Requires ltx-2-mlx 0.15+.",
            backend: .ltx2Mlx,
            minRecommendedRAMGB: 64,
            usesBundledGemma4: true,
